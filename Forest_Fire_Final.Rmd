...
```{r}
ggplot(forest_fire, aes(x=month, y=DMC))  + geom_point(size=2, aes(color = fire_size), alpha=0.5) + labs(x="Month",  y="DC", title = "Dryness of organic layer at moderate depth by month")
```
