...
forest_fire$fire_size <- cut(forest_fire$area, breaks=c(-0.01,0.01, 12.85, Inf), labels=c('Low','Medium','High'))
...
```
DMC seems to have no bearing on the size of the fire.

```{r}
#plot(forest_fire$day,forest_fire$fire_size,  ylab= 'Fire Size', xlab = 'Day of the week')
